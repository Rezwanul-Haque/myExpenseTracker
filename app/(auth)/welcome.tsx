    ...
    <ScreenWrapper>
      <View style={styles.container}>
        ...
        <View style={styles.footer}>
          ...
          >
            <Typography size={17} color={colors.textLight}>Finances must be arranged to set a better</Typography>
            <Typography size={17} color={colors.textLight}>lifestyle in future</Typography>
          </Animated.View>
